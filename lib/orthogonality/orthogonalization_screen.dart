...
class OrthogonalizationScreen extends StatefulWidget {
  @override
  _OrthogonalizationScreenState createState() =>
      _OrthogonalizationScreenState();
}

class _OrthogonalizationScreenState extends State<OrthogonalizationScreen> {
  int numVectors = 2;
  int vectorSize = 3;
  ...
  List<List<double>> _gramSchmidt(List<List<double>> vectors) {
  ...
  void _orthogonalize() {
    ...
    List<List<double>> ortho = _gramSchmidt(vectors);
